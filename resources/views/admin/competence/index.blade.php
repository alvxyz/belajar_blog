                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" data-id="{{ $competence->id }}" class="btn btn-sm btn-danger swal-confirm">
                                <form action="{{ route('competence.delete', ['id' => $competence->id]) }}" method="POST"
                                    id="delete{{ $competence->id }}">
                                    @csrf
                                    @method('delete')
                                </form>
