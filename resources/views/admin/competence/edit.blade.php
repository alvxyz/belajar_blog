...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="mt-0 mb-2 header-title">Edit Kompetensi Lulusan</h4>

            <div class="p-2">
                <form action="{{ route('competence.update', ['id' => $competence->id]) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea name="content" class="form-control @error('content') is-invalid @enderror"
                                rows="5" id="editor">{{ $competence->content }}</textarea>
                            @error('content')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
