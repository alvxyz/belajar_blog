...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="mt-0 mb-2 header-title">Add Capaian Pembelajaran</h4>

            <div class="p-2">
                <form action="{{ route('achievement.store') }}" method="POST" class="form-horizontal" role="form">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="period" type="text" id="simpleinput"
                                ...
                                placeholder="Masukkan Periode Capaian Pembelajaran" value="{{ old('title') }}">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="example-textarea">Capaian Pembelajaran</label>
                        <div class="col-md-10">
