...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="mt-0 mb-2 header-title">Add Fasilitas</h4>
                ...
                <form action="{{ route('facility.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="name" type="text" id="simpleinput"
                                ...
                                placeholder="Masukkan Nama Fasilitas" value="{{ old('title') }}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <small id="emailHelp" class="form-text text-muted">Masukkan Gambar dengan Resolusi 1240px x
                                700px atau 16:9</small>
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
