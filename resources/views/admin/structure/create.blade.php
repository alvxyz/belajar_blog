...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="mt-0 mb-2 header-title">Add Struktur Organisasi</h4>
                ...
                <form action="{{ route('structure.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="period" type="text" id="simpleinput"
                                ...
                                placeholder="Masukkan Periode Sturktur Organisasi, contoh: Struktur Organisasi Tahun 2021"
                                value="{{ old('title') }}">
                            @error('period')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <small id="emailHelp" class="form-text text-muted">Masukkan Gambar dengan Resolusi 1600x
